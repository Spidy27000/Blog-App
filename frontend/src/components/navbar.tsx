        ...
        <>
            <nav className="p-6 pr-8 pl-8 flex justify-between  items-center sticky top-0 bg-white z-20">
                ...
                <div className='flex md:gap-8 gap-4'>
                    {!isLoged && <a href="/login" className="font-santoshi-bold bg-accent hover:bg-[#eee] transition-all ease duration-300 p-2 flex justify-center items-center gap-3 md:pr-5 md:pl-5 pr-3 pl-3 rounded-sm active:scale-90"><User width={20} /><span className='hidden md:block'>Login</span></a>}

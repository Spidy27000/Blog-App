                ...
                <div className='flex gap-8'>
                    ...
                    <Popover>
                        ...
                        <PopoverContent className='flex flex-col w-auto gap-1 font-santoshi-medium p-2 mt-2 mr-2'>
                            <a href="/admin" className='hover:bg-accent rounded-sm h-full transition-all ease duration-300 p-2 pr-5 pl-5 flex justify-between items-center gap-2'>My Post <NotebookText size={19} className='h-full flex justify-center items-center'/></a>
                            <AlertDialog>
                                <AlertDialogTrigger className='hover:bg-accent rounded-sm transition-all ease cursor-pointer duration-300 p-2 pr-5 pl-5 flex justify-between items-center gap-4 hover:text-red-700'>Log out  <LogOut size={19}/></AlertDialogTrigger>
                                <AlertDialogContent>
                                    <AlertDialogHeader>

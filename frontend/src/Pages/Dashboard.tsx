  ...
  return (
    <>
      ...
      <div className="w-full mt-8 flex justify-center items-center flex-col gap-5">
        ...
        {/* skeleton card */}
        {loading && (<>
          <div className="md:w-[38rem] w-[20rem] h-[10rem] flex justify-center items-center gap-5 mt-10">
        ...
        {/* Contents */}
        {!loading && (homepageData.map(data =><div key={data.id} className="md:max-w-[38rem] font-santoshi md:h-[14rem] h-[10rem] border-b-1 w-[80%] group pb-5 flex flex-col justify-center content">
          <Posts title={data.title} id={data.id} image_url={data.image_url} short_description={data.short_description} author={data.author} creation_date={data.creation_date} /> </div>))}
